"""
RL training with a weighted Gaussian (mean + covariance) belief encoder for
the Smart Ant-Tag variant.

This is 4_train_rl_gaussian.py's exact pipeline (PF, curriculum, reward
shaping, WeightedGaussianFeaturesExtractor, training loop, CLI) pointed at
...
Everything else is reused unchanged from 4_train_rl_gaussian.py's main() via
...
if __name__ == "__main__":
    _train_rl_gaussian.main(
        ...
        run_subdir="ant_tag_gaussian_smart",
    )
