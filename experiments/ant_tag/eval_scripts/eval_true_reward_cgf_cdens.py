"""
Evaluate a weighted-CGF checkpoint trained on Counterweighted-Den Ant-Tag, on
the REAL sparse tag reward. Identical to eval_true_reward_cgf.py's eval loop,
...
Usage:
    python3 eval_scripts/eval_true_reward_cgf_cdens.py \
        --model_path runs/ant_tag_cgf_cdens/<run>/models/best_model/best_model.zip \
        --vecnormalize_path runs/ant_tag_cgf_cdens/<run>/models/vecnormalize.pkl \
