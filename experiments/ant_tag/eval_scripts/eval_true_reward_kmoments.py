"""
Evaluate a kmoments checkpoint (4_train_rl_kmoments.py) on the REAL sparse tag reward.

WeightedKMomentsFeaturesExtractor consumes the same Dict observation as WeightedCGFFeaturesExtractor
...
without this module; importing 4_train_rl_pool here keeps the arms symmetric.
    ...
    python3 eval_scripts/eval_true_reward_kmoments.py --variant smart \
        ...
        --vecnormalize_path runs/ant_tag_kmoments_smart/<run>/models/vecnormalize.pkl --n_episodes 100
"""
