"""
Evaluate a pointnet checkpoint (4_train_rl_pointnet.py) on the REAL sparse tag reward.

PointNetFeaturesExtractor consumes the same Dict observation as WeightedCGFFeaturesExtractor
...
without this module; importing 4_train_rl_pool here keeps the arms symmetric.
    ...
    python3 eval_scripts/eval_true_reward_pointnet.py --variant smart \
        ...
        --vecnormalize_path runs/ant_tag_pointnet_smart/<run>/models/vecnormalize.pkl --n_episodes 100
"""
