...
# The env factory and its helpers live in the domain module since 2026-09-12 (change 1c);
# re-exported here as the SAME objects because 4_train_rl_{st,gaussian,pool}.py,
# 2_collect_pf_dataset.py and the tests read them off this module by name.
from set_transformer.rl.domains.ant_tag import (  # noqa: E402
