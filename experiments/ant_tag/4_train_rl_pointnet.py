"""
RL training with the pointnet belief encoder for Ant-Tag: PointNetFeaturesExtractor.

Entry point only. The trainer, argparse and run-dir conventions live in
4_train_rl_pool.py (main(encoder="pointnet")); this file exists so the arm has the
...
tests/test_ant_tag_shared_pieces_regression.py).
    ...
    python3 4_train_rl_pointnet.py --variant smart --seed 0 [--run_tag <tag>]
    python3 eval_scripts/eval_true_reward_pointnet.py --variant smart --model_path <zip> ...
"""
...
PointNetFeaturesExtractor = _pool.PointNetFeaturesExtractor
